...
const Products = ({ access }) => {
  ...
  useEffect(() => {
    ...
    loadData()
  }, [order, filter, search, refresh, limit, page])
      ...
      <Modal
        ...
        <Modal.Footer className="footer-react-bootstrap d-flex justify-content-between">
          <div className="d-flex">
            ...
            <Button onClick={() => Navigate(`/product/update/${oneData.id}`)} className="Btn Send  me-2" title="Modifier infos"><RemixIcons.RiPenNibLine />Modifier le prod.</Button>
          </div>
          <div>
